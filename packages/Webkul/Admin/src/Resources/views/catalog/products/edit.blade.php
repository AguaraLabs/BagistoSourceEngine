<x-admin::layouts>
    <x-slot:title>
        ...
        >
            ...
            @if($errors->any())
                <div class="mt-2 grid gap-2.5 p-3 max-xl:flex-wrap">
                    <div
                        class="grid w-full gap-2 rounded-sm border border-orange-200 bg-orange-50 p-3 dark:border-gray-800 dark:bg-gray-900 dark:text-white"
                    >
                        <p class="flex items-center gap-2">
                            <b>Atención:</b> Uno o más campos podrían estar con algún error de validación, los campos han sido señalados en rojo
                        </p>
